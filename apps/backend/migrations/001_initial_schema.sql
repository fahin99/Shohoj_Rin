...
-- This migration creates all base tables for the ShohojRin platform.
-- It is the canonical clean-install schema and should be kept in sync
-- with tablecreation.sql (which additionally includes DROP TABLE statements
-- for local development resets).
