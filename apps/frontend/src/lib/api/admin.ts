...
export async function reviewApplication(id: string, data: { decision: "approved" | "rejected"; reason?: string }) {
...
export async function reviewVerification(id: string, data: { status: "approved" | "rejected" | "needs_review"; notes?: string }) {
