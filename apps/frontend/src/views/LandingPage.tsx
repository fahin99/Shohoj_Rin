            ...
            <div className="relative bg-white border-[1.5px] border-navy rounded-[8px] shadow-nb-lg p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="font-display tabular-nums text-xl font-semibold text-navy mt-0.5">
                    ৳2,00,000
                  </p>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {howItWorks.map((item) => (
              ...
              >
                <p className="font-display tabular-nums text-3xl font-medium text-stone-200 mb-3">
                  {item.step}
                </p>
            ...
            {literacyCards.map((card, i) => (
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-xs bg-teal-light text-teal px-2 py-0.5 rounded-[3px] font-medium border border-teal/20">
                    {card.tag}
                  </span>
