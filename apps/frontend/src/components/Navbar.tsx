  ...
  return (
    <header
      className={`sticky top-0 z-40 w-full border-b transition-colors ${
        transparent ? 'bg-transparent border-transparent' : 'bg-offwhite/95 backdrop-blur-sm border-stone-200'
      }`}
    >
        ...
        >
          {menuOpen ? (
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path d="M3 3l12 12M15 3L3 15" stroke="#0D1B2A" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
          ) : (
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path d="M2 4.5h14M2 9h14M2 13.5h14" stroke="#0D1B2A" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
          )}
        </button>
      </div>
