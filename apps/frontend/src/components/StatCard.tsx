  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <p className="min-w-0 text-xs font-medium uppercase tracking-wide text-stone-500">
          {label}
        </p>
      </div>
      <p
        className={`font-display tabular-nums text-xl font-semibold leading-tight sm:text-2xl ${t.value}`}
      >
        {value}
      </p>
