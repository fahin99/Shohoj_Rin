    ...
    return (
      <InputWrapper label={label} error={error} hint={hint} required={required}>
        <div className="relative flex items-center">
          {prefix && (
            <span className="absolute left-3 text-stone-500 text-sm pointer-events-none">
              {prefix}
            </span>
          )}
          <input
          ...
          />
          {suffix && (
            <span className="absolute right-3 text-stone-500 text-sm pointer-events-none">
              {suffix}
            </span>
          )}
        </div>
  ...
  return (
    <InputWrapper label={label} error={error} hint={hint} required={required}>
      <div className="relative">
        ...
        <span className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-stone-400 text-xs">
          ▼
        </span>
      </div>
    </InputWrapper>
      ...
      <label
        className={`flex flex-col items-center justify-center gap-2 p-6 rounded-[6px] border-[1.5px] border-dashed cursor-pointer transition-colors ${
          error
            ...
            : "border-stone-300 bg-white hover:border-teal hover:bg-teal-light/30"
        }`}
      >
